...
const ALL_TILE_FIELDS = [
  ...
  "reservationIds", "inventoryReserved", "inventoryConsumed"
];
...
export function requiresInventoryReserve(fromStatus, toStatus) {
  return fromStatus === TILE_STATUSES.DRAFT && toStatus === TILE_STATUSES.PENDING_FIRING;
}

export function requiresInventoryRelease(fromStatus, toStatus) {
  return fromStatus === TILE_STATUSES.PENDING_FIRING && toStatus === TILE_STATUSES.DRAFT;
}

export function requiresInventoryConfirm(fromStatus, toStatus) {
  return fromStatus === TILE_STATUSES.PENDING_FIRING && toStatus === TILE_STATUSES.FIRED;
}
