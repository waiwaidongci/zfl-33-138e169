...
const seedLegacy = {
  ...
  batches: [],
  materialStocks: [
    { id: "MAT-001", name: "松灰", batchNo: "SG-2026-001", quantity: 50, reservedQuantity: 0, unit: "kg", entryDate: "2026-05-15", supplier: "南山灰场", reorderThreshold: 10, notes: "当年春采集", createdAt: "2026-05-15", updatedAt: "2026-05-15" },
    { id: "MAT-002", name: "长石", batchNo: "CS-2026-001", quantity: 80, reservedQuantity: 0, unit: "kg", entryDate: "2026-05-20", supplier: "景德镇矿物站", reorderThreshold: 15, notes: "钾长石", createdAt: "2026-05-20", updatedAt: "2026-05-20" },
    { id: "MAT-003", name: "石英", batchNo: "SY-2026-001", quantity: 60, reservedQuantity: 0, unit: "kg", entryDate: "2026-05-22", supplier: "景德镇矿物站", reorderThreshold: 10, notes: "200目石英粉", createdAt: "2026-05-22", updatedAt: "2026-05-22" },
    { id: "MAT-004", name: "红土", batchNo: "HT-2026-001", quantity: 30, reservedQuantity: 0, unit: "kg", entryDate: "2026-06-01", supplier: "本地采集", reorderThreshold: 5, notes: "含铁量较高", createdAt: "2026-06-01", updatedAt: "2026-06-01" }
  ],
  inventoryTransactions: [],
  businessEvents: []
};
...
export function insertTiles(db, tiles) {
  ...
  for (const t of tiles) {
    ...
    if (t.inventoryReserved === undefined) t.inventoryReserved = false;
    if (t.inventoryConsumed === undefined) t.inventoryConsumed = false;
    if (t.reservationIds === undefined) t.reservationIds = [];
    coll.tiles.push(t);
    existing.add(t.id);
    inserted.push(t);
  }
